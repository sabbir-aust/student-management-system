<footer class="footer">
            ...
            <div class="container">
                ...
                <div class="footer-col col-md-3 col-sm-4 about">
                    <div class="footer-col-inner">
                        <h3>About</h3>
                        <ul>
                            <li><a href="index.php"><i class="fa fa-caret-right"></i>About us</a></li>
                ...
                <div class="footer-col col-md-6 col-sm-8 newsletter">
                    <div class="footer-col-inner">
                        ...
                        <p>Subscribe to get our update</p>
                        ...
                        <div class="row">
                            <p class="adr clearfix col-md-12 col-sm-4">
                                ...
                                <span class="adr-group pull-left">       
                                    <span class="street-address">AUST</span><br>
                                    <span class="region">141 & 142, Love Road, Tejgaon Industrial Area</span><br>
                                    <span class="postal-code">Dhaka-1208</span><br>
                                    <span class="country-name">Bangladesh</span>
                                </span>
                            </p>
                            <p class="tel col-md-12 col-sm-4"><i class="fa fa-phone"></i>Tel. (8802) 8870422, Ext. 107, 114, Fax : (8802) 8870417-18</p>
                            <p class="email col-md-12 col-sm-4"><i class="fa fa-envelope"></i><a href="#">www.aust.edu</a></p>  
                        </div> 
                    </div><!--//footer-col-inner-->            
                </div><!--//foooter-col-->   
                </div>   
        ...
        <div class="bottom-bar">
            <div class="container">
                <div class="row">
                    <small class="copyright col-md-6 col-sm-12 col-xs-12">Copyright @ 2016 Loppers_33</small>
