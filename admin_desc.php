            ...
            <div class="page-content">     
                <div class="row page-row">
                    <ul class="nav nav-tabs">
                          ...
                          <li class="active"><a href="admin_desc.php">Description</a></li>
                    ...
                    <div class="col-md-12">
                    <a href="desc_add.php" class="btn btn-sm btn-primary pull-right">
                            Insert Description
                          </a>
                      ...
                      <table class="table table-hover">
                          <thead>
                            ...
                            <?php
                              ...
                              $rslt=mysqli_query($con,"SELECT * from description");
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <a href="desc_edit.php?id=<?php echo $row['description_id']; ?>">
                                    Edit
                                  </a>
                                </td>
                                <td>
                                  <a onclick="return confirm('do you really want to delete this?')"
                                    href="desc_del.php?id=<?php echo $row['description_id']; ?>">
                                    delete
                                  </a>
                                </td>
                              </tr>
